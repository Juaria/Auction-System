...
<nav class="navbar navbar-inverse navbar-fixed-top">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="userstat"><a href="#">User Statistics</a></li>
    ...
    <ul class="nav navbar-nav navbar-right">
      ...
      <li><a href="#"><button2 onclick="document.getElementById('id01').style.display='block'" style="width:auto;"><span class="glyphicon glyphicon-log-out"></span><a href="logout.php">Logout</a></a></button2></li>
    </ul>
  </div>
...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:240px; height:100%;" id="mySidebar"><br>
  <div class="w3-container">
    ...
    <img src="img/logo.jpg" style="width:80%;" class="w3-round"><br><br>
    <h4><b>Admin: Juaria Iqbal</b></h4>
    <p class="w3-text-grey">Artist and Designer</p>
  </div>
  ...
  <div class="w3-bar-block">
    ...
    <a href="#userstat" onclick="w3_close()" class="w3-bar-item w3-button w3-padding w3-text-teal"><i class="fa fa-bar-chart fa-fw w3-margin-right"></i>View User Statistics</a>
  ...
  <div class="w3-row-padding">
    <div class="w3-third w3-container w3-margin-bottom">
      ...
      <div class="w3-container w3-white">
        ...
        <p style="color: #A91564"><b>Bid Price:</b> 16000bdt</p>
        <button class="open-button" onclick="openForm()">View Bidders</button>  
...
<div class="form-popup" id="myForm">
  <form action="bid.php" class="form-container" method="POST">
    <h3 style="color:teal; text-align: center"><b>BIDDERS</b></h3>

    <img src="img/jonsnow.jpg" alt="Norway" style="border: 2px solid #FFFFFF; border-radius: 1px; width:20%" class="w3-hover-opacity">
    <p><b>User 1</b></p>
    <p>user1@gmail.com</p>
    <p><b>Bid amount: 1200</b></p>

   	<div class="row2">
    <div class = "container">
    	<i class="glyphicon glyphicon-remove"></i>
    	<i class="glyphicon glyphicon-envelope"></i></div></div>

   
    <img src="img/user3.png" alt="Norway" style="border: 2px solid #FFFFFF; border-radius: 1px; width:20%" class="w3-hover-opacity">
    <p><b>User 2</b></p>
    <p>user2@gmail.com</p>
    <p><b>Bid amount: 1500</b></p>
...
function closeForm() {
  ...
  <div class="w3-container w3-padding-large" style="margin-bottom:32px">
    ...
    <div class="w3-grey">
      <div class="w3-container w3-purple w3-padding w3-center" style="width:95%">92%</div>
    </div><br>
    <p>France</p>
    <div class="w3-grey">
      <div class="w3-container w3-light-blue w3-padding w3-center" style="width:85%">85%</div>
    </div><br>
    <p>Russia</p>
    <div class="w3-grey">
      <div class="w3-container w3-indigo w3-padding w3-center" style="width:80%">80%</div>
    </div>
    <p>
      <button class="w3-button w3-pale-red w3-padding-large w3-margin-top w3-margin-bottom" style="border: 1px solid MediumAquamarine">
        <i class="fa fa-download w3-margin-right"></i><a href="img/Report.docx" download><b>Download Report</b></button>
    </p>
    <hr></header>
